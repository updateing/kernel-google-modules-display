...
/* DP_LINK base address : 0x110F0000 for 9865 */

#define OSC_CLK				 40 // MHz Unit
...
#define SW_RESET			 (1 << 0)
#define SW_RESET_RELEASE		 (0 << 0)
#define SW_RESET_GET(_v)		 (((_v) >> 0) & 0x1)
#define SW_RESET_MASK			 (0x1 << 0)

#define SYSTEM_CLK_CONTROL		 (0x0008) // update for 9865
#define GFMUX_STATUS_TXCLK10_MASK	 (0x3 << 10)
#define GFMUX_STATUS_TXCLK_GET(_v)	 (((_v) >> 8) & 0x3)
#define GFMUX_STATUS_TXCLK_MASK		 (0x3 << 8)
#define GFCLKMUX_SEL_10_OSC		 (0x0 << 5)
#define GFCLKMUX_SEL_10_TX		 (0x1 << 5)
#define GFCLKMUX_SEL_10_MASK		 (0x1 << 5)
#define GFCLKMUX_SEL_20_OSC		 (0x0 << 4)
#define GFCLKMUX_SEL_20_TX		 (0x1 << 4)
#define GFCLKMUX_SEL_20_MASK		 (0x1 << 4)

#define SYSTEM_OSCLK_QCH_FUNCTION_ENABLE (0x000C) // new for 9865
#define OSCCLK_QCH_FUNC_EN_SET(_v)	 (((_v)&0x1) << 0)
#define OSCCLK_QCH_FUNC_EN_MASK		 (0x1 << 0)
...
#define BIT_SWAP_SET(_v)		(((_v)&0x1) << 2)
#define BIT_SWAP_MASK			(0x1 << 2)
...
#define SST1_INTERRUPT_STATUS_SET0		       (0x5024) // update for 9865
...
#define SST1_INTERRUPT_MASK_SET0		       (0x502C) // update for 9865
#define INT_FAIL_SAFE_TRIGGER_MASK		       (0x1 << 10)
...
#define SST1_VIDEO_DSC_STREAM_CONTROL_3		       (0x5440) // new for 9865
#define SST1_VIDEO_DSC_STREAM_CONTROL_4		       (0x5444) // new for 9865
...
// SST1 DSC CRC
#define SST1_DSC_CRC_CONTROL_1			       (0x5514) // new for 9865
#define CLEAR_DSC_CRC_LFSR			       (0x1 << 1)
#define DSC_CRC_ENABLE				       (0x1 << 0)
#define SST1_DSC_CRC_CONTROL_2			       (0x5518) // new for 9865
#define SST1_DSC_CRC_CONTROL_3			       (0x551C) // new for 9865
#define SST1_DSC_CRC_CONTROL_4			       (0x5520) // new for 9865
#define DSC_CRC_X				       (0xFFFF << 0)
...
#define SST1_INFOFRAME_UPDATE_CONTROL		       (0x5C04) // update for 9865
#define HDR10PLUS_INFO_UPDATE_SET(_v)		       (((_v)&0x1) << 6)
#define HDR10PLUS_INFO_UPDATE_MASK		       (0x1 << 6)
#define ADAPTIVE_SYNC_INFO_UPDATE_SET(_v)	       (((_v)&0x1) << 5)
#define ADAPTIVE_SYNC_INFO_UPDATE_MASK		       (0x1 << 5)
...
#define SST1_INFOFRAME_SEND_CONTROL		       (0x5C08) // update for 9865
#define HDR10PLUS_INFO_SEND_SET(_v)		       (((_v)&0x1) << 6)
#define HDR10PLUS_INFO_SEND_MASK		       (0x1 << 6)
#define ADAPTIVE_SYNC_INFO_SEND_SET(_v)		       (((_v)&0x1) << 5)
#define ADAPTIVE_SYNC_INFO_SEND_MASK		       (0x1 << 5)
...
// SST1 Adaptive Sync Infoframe: New for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_0 (0x5CC0) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_1 (0x5CC4) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_2 (0x5CC8) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_3 (0x5CCC) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_4 (0x5CD0) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_5 (0x5CD4) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_6 (0x5CD8) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_DATA_SET_7 (0x5CDC) // new for 9865

#define SST1_ADAPTIVE_SYNC_FEATURE_ENABLE	       (0x5CE0) // new for 9865
#define ADAPTIVE_SYNC_FEATURE_ENABLE		       (0x1 << 0)

#define MAX_ADAPTIVE_SYNC_INFOFRAME_DATA_BYTE_SIZE     4 // 4 Bytes: Byte 0 ~ Byte 3
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_HEADER_SET (0x5CE4) // new for 9865
#define SST1_INFOFRAME_ADAPTIVE_SYNC_PACKET_PARITY_SET (0x5CE8) // new for 9865

#define SST1_ADAPTIVE_SYNC_FAIL_SAFE_FEATURE	       (0x5CEC) // new for 9865
#define FAIL_SAFE_FEATURE_ENABLE		       (0x1 << 16)
#define FAIL_SAFE_VALUE				       (0xFFFF << 0)

// SST1 SDP Data Payload
...
// SST1 HDR10+ Infoframe: New for 9865
#define MAX_HDR10PLUS_INFOFRAME_DATA_BYTE_SIZE	       4 // 4 Bytes: Byte 0 ~ Byte 3
#define SST1_INFOFRAME_HDR10PLUS_PACKET_HEADER_SET     (0x5D84) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_PARITY_SET     (0x5D88) // new for 9865

#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_0     (0x5D8C) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_1     (0x5D90) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_2     (0x5D94) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_3     (0x5D98) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_4     (0x5D9C) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_5     (0x5DA0) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_6     (0x5DA4) // new for 9865
#define SST1_INFOFRAME_HDR10PLUS_PACKET_DATA_SET_7     (0x5DA8) // new for 9865
