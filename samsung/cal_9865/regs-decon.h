...
#define VIDEO_FRAME_CON_F_MASK			(0xf << 0)
...
#define SHD_REG_UP_REQ_DQE_CGC			(1 << 26)
#define SHD_REG_UP_REQ_DQE_ROI			(1 << 25)
#define SHD_REG_UP_REQ_DQE			(1 << 24)
#define SHD_REG_UP_REQ_CMP			(1 << 20)
#define SHD_REG_UP_REQ_WIN(_win)		(1 << (_win))
#define SHD_REG_UP_REQ_FOR_DECON		(0x3fff)
...
#define DISP_TIMER_CTL				(0x0090)

#define DISP_TIMER_VAL_0			(0x0094)

#define DISP_TIMER_VAL_1			(0x0098)

#define DISP_TIMER_VAL_2			(0x009C)
...
#define SEL_CH15				(3 << 28)
#define SEL_CH14				(3 << 24)
#define SEL_CH13				(3 << 20)
#define SEL_CH12				(3 << 16)
#define SEL_CH11				(3 << 12)
#define SEL_CH10				(3 << 8)
#define SEL_CH9					(3 << 4)
#define SEL_CH8					(3 << 0)

#define RSC_STATUS_2				(0x0108)
#define SEL_WIN7				(3 << 28)
#define SEL_WIN6				(3 << 24)
...
#define SEL_WIN15				(3 << 28)
#define SEL_WIN14				(3 << 24)
#define SEL_WIN13				(3 << 20)
#define SEL_WIN12				(3 << 16)
#define SEL_WIN11				(3 << 12)
#define SEL_WIN10				(3 << 8)
#define SEL_WIN9				(3 << 4)
#define SEL_WIN8				(3 << 0)

#define RSC_STATUS_4				(0x0110)
#define SEL_DSC7				(3 << 28)
#define SEL_DSC6				(3 << 24)
#define SEL_DSC5				(3 << 20)
#define SEL_DSC4				(3 << 16)
#define SEL_DSC3				(3 << 12)
#define SEL_DSC2				(3 << 8)
#define SEL_DSC1				(3 << 4)
#define SEL_DSC0				(3 << 0)

#define RSC_STATUS_5				(0x0114)
#define SEL_DSCC3				(3 << 20)
#define SEL_DSCC2				(3 << 16)
#define SEL_DSCC1				(3 << 12)
#define SEL_DSCC0				(3 << 8)
#define SEL_VDCM1				(3 << 4)
#define SEL_VDCM0				(3 << 0)

#define RSC_STATUS_6				(0x0118)
#define SEL_WB1					(3 << 20)
#define SEL_WB0					(3 << 16)
#define SEL_SCALER1				(3 << 4)
#define SEL_SCALER0				(3 << 0)
...
#define ENHANCE_PATH_GET(_v)			(((_v) >> 12) & 0xf)
...
#define BLENDER_BG_PM_F(_v)			((_v) << 28)
#define BLENDER_BG_PM_MASK			(0x3 << 28)
#define BLENDER_BG_PM_GET(_v)			(((_v) >> 28) & 0x3)
...
#define SRAM_EN_OF_PRI_1			(0x0304)
#define SRAM15_EN_F				(1 << 28)
#define SRAM14_EN_F				(1 << 24)
...
#define SRAM_EN_OF_PRI_2			(0x0308)
#define SRAM23_EN_F				(1 << 28)
#define SRAM22_EN_F				(1 << 24)
#define SRAM21_EN_F				(1 << 20)
#define SRAM20_EN_F				(1 << 16)
#define SRAM19_EN_F				(1 << 12)
#define SRAM18_EN_F				(1 << 8)
#define SRAM17_EN_F				(1 << 4)
#define SRAM16_EN_F				(1 << 0)

#define SRAM_EN_OF_PRI_3			(0x030C)
#define SRAM31_EN_F				(1 << 28)
#define SRAM30_EN_F				(1 << 24)
#define SRAM29_EN_F				(1 << 20)
#define SRAM28_EN_F				(1 << 16)
#define SRAM27_EN_F				(1 << 12)
#define SRAM26_EN_F				(1 << 8)
#define SRAM25_EN_F				(1 << 4)
#define SRAM24_EN_F				(1 << 0)

#define SRAM_EN_OF_PRI_4			(0x0310)
...
#define SRAM_EN_OF_SEC_3			(0x032C)
#define SRAM_EN_OF_SEC_4			(0x0330)

#define EWR_CON					(0x0400)
#define EWR_EN_F				(1 << 0)

#define EWR_TIMER				(0x0404)
#define TIMER_VALUE(_v)				((_v) << 0)
#define TIMER_VALUE_GET(_v)			(((_v) >> 0) & 0xffffffff)

#define PLL_SLEEP_CON				(0x0410)
...
#define WIN_CHMAP_GET(_v)			((_v >> 4) & 0xF)
...
#define DSC_CONTROL1(_id)			(DSC_OFFSET(_id) + 0x0004)
...
#define DSC_CONTROL3(_id)			(DSC_OFFSET(_id) + 0x000C)
...
#define DSC_CRC_1(_id)				(DSC_OFFSET(_id) + 0x0020)
...
#define DSC_CRC_2(_id)				(DSC_OFFSET(_id) + 0x0024)
#define DSC_CRC_CG_S0_MASK			(0xffff << 16)
#define DSC_CRC_CG_S0_F(_v)			((_v) << 16)
#define DSC_CRC_Y2_S1_MASK			(0xffff << 0)
#define DSC_CRC_Y2_S1_F(_v)			((_v) << 0)

#define DSC_CRC_3(_id)				(DSC_OFFSET(_id) + 0x0028)
#define DSC_CRC_Y_S1_MASK			(0xffff << 16)
#define DSC_CRC_Y_S1_F(_v)			((_v) << 16)
#define DSC_CRC_CO_S1_MASK			(0xffff << 0)
#define DSC_CRC_CO_S1_F(_v)			((_v) << 0)

#define DSC_CRC_4(_id)				(DSC_OFFSET(_id) + 0x002C)
#define DSC_CRC_CG_S1_MASK			(0xffff << 16)
#define DSC_CRC_CG_S1_F(_v)			((_v) << 16)
#define DSC_CRC_Y2_S1_MASK			(0xffff << 0)
#define DSC_CRC_Y2_S1_F(_v)			((_v) << 0)
...
#define DSC_PPS12_15(_id)			(DSC_OFFSET(_id) + 0x004C)
...
#define DSC_PPS16_19(_id)			(DSC_OFFSET(_id) + 0x0050)
...
#define DSC_PPS20_23(_id)			(DSC_OFFSET(_id) + 0x0054)
...
#define DSC_PPS24_27(_id)			(DSC_OFFSET(_id) + 0x0058)
...
#define DSC_PPS28_31(_id)			(DSC_OFFSET(_id) + 0x005C)
/* NFL : Not First Line */
...
#define DSC_PPS32_35(_id)			(DSC_OFFSET(_id) + 0x0060)
...
#define DSC_PPS36_39(_id)			(DSC_OFFSET(_id) + 0x0064)
...
#define DSC_PPS40_43(_id)			(DSC_OFFSET(_id) + 0x0068)
...
#define DSC_PPS44_47(_id)			(DSC_OFFSET(_id) + 0x006C)
...
#define DSC_PPS48_51(_id)			(DSC_OFFSET(_id) + 0x0070)
...
#define DSC_PPS52_55(_id)			(DSC_OFFSET(_id) + 0x0074)
...
#define DSC_PPS56_59(_id)			(DSC_OFFSET(_id) + 0x0078)
...
#define DSC_PPS60_63(_id)			(DSC_OFFSET(_id) + 0x007C)
#define DSC_PPS64_67(_id)			(DSC_OFFSET(_id) + 0x0080)
#define DSC_PPS68_71(_id)			(DSC_OFFSET(_id) + 0x0084)
#define DSC_PPS72_75(_id)			(DSC_OFFSET(_id) + 0x0088)
#define DSC_PPS76_79(_id)			(DSC_OFFSET(_id) + 0x008C)
#define DSC_PPS80_83(_id)			(DSC_OFFSET(_id) + 0x0090)
#define DSC_PPS84_87(_id)			(DSC_OFFSET(_id) + 0x0094)

#define DSC_PPS92_95(_id)			(DSC_OFFSET(_id) + 0x0098)
#define PPS91_SLICE_NUM_BIT(_v)			((_v) << 0)
#define PPS91_SLICE_NUM_BIT_MASK		(0xFF << 0)

#define DSC_PPS96_99(_id)			(DSC_OFFSET(_id) + 0x009C)
...
#define DSC_PPS100_103(_id)			(DSC_OFFSET(_id) + 0x00A4)
#define PPS100_101_SLICES_PER_LINE(_v)		((_v) << 16)
#define PPS101_101_SLICES_PER_LINE_MASK		(0xFFFF)
#define PPS102_SLICE_PAD_X(_v)			((_v) << 8)
#define PPS102_SLICE_PAD_X_MASK			(0xFF)
#define PPS103_MPP_MIN_STEP_SIZE(_v)		((_v) << 0)
#define PPS103_MPP_MIN_STEP_SIZE_MASK		(0xFF)

#define DSC_DEBUG_EN(_id)			(DSC_OFFSET(_id) + 0x00E0)
#define DSC_DBG_EN_MASK				(1 << 31)
#define DSC_DBG_EN(_v)				((_v) << 31)
#define DSC_DBG_SEL_MASK			(0xffff << 0)
#define DSC_DBG_SEL(_v)				((_v) << 0)

#define DSC_DEBUG_DATA(_id)			(DSC_OFFSET(_id) + 0x00E4)

#define DSCC_DEBUG_EN				(DSC_OFFSET(0) + 0x00E8)
#define DSCC_DBG_EN_MASK			(1 << 31)
#define DSCC_DBG_EN(_v)				((_v) << 31)
#define DSCC_DBG_SEL_MASK			(0xffff << 0)
#define DSCC_DBG_SEL(_v)			((_v) << 0)

#define DSCC_DEBUG_DATA				(DSC_OFFSET(0) + 0x00EC)
