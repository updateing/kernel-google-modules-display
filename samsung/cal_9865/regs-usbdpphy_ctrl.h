...
#define DP_TX_REQ_STATUS_GET(_v)	     (((_v) >> 12) & 0xF)
#define DP_TX_REQ_STATUS_SET_4LANES	     ((0xF & 0xF) << 12)
#define DP_TX_REQ_STATUS_SET_2LANES	     ((0x3 & 0xF) << 12)
#define DP_TX_REQ_STATUS_MASK		     (0xF << 12)
...
#define DP_TX_ENABLE_SET_4LANES		     ((0x0 & 0xF) << 0)
#define DP_TX_DISABLE_SET_4LANES	     ((0xF & 0xF) << 0)
#define DP_TX_ENABLE_SET_2LANES		     ((0xC & 0xF) << 0)
#define DP_TX_DISABLE_SET_2LANES	     ((0xF & 0xF) << 0)
