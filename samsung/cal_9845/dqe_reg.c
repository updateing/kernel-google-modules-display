...
void dqe_reg_set_degamma_lut(u32 dqe_id, const struct drm_color_lut *lut)
{
	...
	for (i = 0; i < DIV_ROUND_UP(DEGAMMA_LUT_SIZE, 2); ++i) {
		...
		degamma_write_relaxed(dqe_id, DQE_DEGAMMALUT(i), val);
