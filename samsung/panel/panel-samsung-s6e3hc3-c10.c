...
/**
 * struct s6e3hc3_c10_mode_data - panel mode specific details
 *
...
/**
 * s6e3hc3_c10_trigger_early_exit - trigger early exit command to panel
 * @ctx: panel struct
 *
 ...
 */
static void s6e3hc3_c10_trigger_early_exit(struct exynos_panel *ctx)
{
...
static const struct exynos_panel_mode s6e3hc3_c10_modes[] = {
	...
	},
	{
		...
		.priv_data = &s6e3hc3_c10_mode_120,
		.te2_timing = {
			.rising_edge = 16,
			.falling_edge = 48,
		},
...
static const struct exynos_panel_mode s6e3hc3_c10_lp_mode = {
	.mode = {
		/* 1440x3120 @ 30Hz */
		.name = "1440x3120x30",
		.clock = 149310,
